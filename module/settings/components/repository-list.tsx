...
import { getConnectedRepositories, disconnectRepository, disconnectAllRepository } from "@/module/settings/actions/index";
    ...
    const disconnectAllMutation = useMutation({
        ...
        onSuccess: (result) => {
            if (result) {
                ...
                toast.error("Error disconnecting all repositories")
            }
        }
    })
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            Are you sure you want to disconnect all {repositories.length} repositories and delete all associated AI reviews.
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
